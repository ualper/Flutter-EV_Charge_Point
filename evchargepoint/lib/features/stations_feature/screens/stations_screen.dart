...
import 'package:evchargepoint/features/stations_feature/widgets/map_utility_buttons.dart';
import 'package:evchargepoint/features/stations_feature/widgets/stations_map.dart';
          ...
          child: Align(
            ...
            child: Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  final station = await Navigator.of(context).pushNamed(searchScreenRoute);
