...
import 'package:evchargepoint/features/stations_feature/widgets/search_query_item.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                if (stationBloc.state.searchQuery.isEmpty && stationBloc.state.recentSearches.isNotEmpty)
                  const Padding(
                  ...
                  builder: (context, state) {
                    if (state.searchQuery.isEmpty) {
                      ...
                      final queriedStations = state.stations
                          .where((element) => element.chargePointId.toLowerCase().startsWith(state.searchQuery))
                          .toList();
