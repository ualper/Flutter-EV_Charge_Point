...
import 'package:evchargepoint/features/stations_feature/widgets/selected_station_modal.dart';
import 'package:evchargepoint/features/stations_feature/widgets/side_button.dart';
import 'package:evchargepoint/features/stations_feature/widgets/stations_bottom_sheet.dart';
import 'package:evchargepoint/features/stations_feature/widgets/filter_stations_bottom_sheet.dart';
        ...
        child: Column(
          ...
          children: [
            SideButton(
              ...
              onPressed: () {
                _showBottomSheetFilters(context);
              },
            ),
...
// TODO FİLTERING
  void _showBottomSheetFilters(BuildContext context) {
    showModalBottomSheet(
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(16),
      ...
      context: context,
      builder: (_) => FilterStationsBottomSheet(),
    );
  }
}
